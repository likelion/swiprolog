...
public class PrologFactImpl extends ASTWrapperPsiElement implements PrologFact {

  public PrologFactImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof PrologVisitor) ((PrologVisitor)visitor).visitFact(this);
