...
public class PrologBodypredicateImpl extends ASTWrapperPsiElement implements PrologBodypredicate {

  public PrologBodypredicateImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof PrologVisitor) ((PrologVisitor)visitor).visitBodypredicate(this);
