...
import com.github.likelion.swiprolog.parser.PrologParser;
import com.github.likelion.swiprolog.psi.PrologFile;
...
public class PrologParserDefinition implements ParserDefinition {
    ...
    public static final IFileElementType FILE = new IFileElementType(Language.<PrologLanguage>findInstance(PrologLanguage.class));
